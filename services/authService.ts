...
import { createUserWithEmailAndPassword, signInWithEmailAndPassword, signOut as firebaseSignOut, onAuthStateChanged, UserCredential } from 'firebase/auth';
import { collection, doc, addDoc, updateDoc, deleteDoc, serverTimestamp, onSnapshot, setDoc} from 'firebase/firestore';
