...
const styles = StyleSheet.create({
  ...
  gapper: { padding: 5},
  timerContainer: { alignItems: 'center', paddingVertical: 10, backgroundColor: '#eef', borderRadius: 10 },
  timer: { fontSize: 45, fontWeight: 'bold', paddingInline: 60, },
  subtext: { fontSize: 16, color: '#666', paddingTop: 7},
  dropZone: {
    width: 250,
    height: 100,
  ...
  dropText: { fontSize: 16, color: '#2d3436' },
  draggable: {
    backgroundColor: '#74b9ff',
    padding: 12,
    borderRadius: 10,
  },
  draggableText: { fontSize: 18, color: '#fff', fontWeight: 'bold' },
  swipeBackground: {
  ...
  swipeText: { color: '#fff', fontSize: 18 },
});